...
type PayrollSalaryRow = { id:string; company_id:string; employee_id:string; name:string; version:number; monthly_fixed:number; earnings:Json; deductions:Json; employer_contributions:Json; effective_from:string; effective_to:string|null; active:boolean; template_id:string|null; monthly_ctc:number|null; monthly_gross:number|null; component_snapshot:Json; component_overrides:Json; workflow_status:string; revision_reason:string|null; created_by:string|null; created_at:string; updated_at:string };
...
type PayrollResultRow = { id:string; company_id:string; run_id:string; employee_id:string; salary_structure_id:string|null; salary_structure_version:number|null; calendar_days:number; eligible_days:number; present_days:number; paid_leave_days:number; weekly_off_days:number; holiday_days:number; lop_days:number; sandwich_lop_days:number; payable_days:number; divisor:number; fixed_earnings:number; other_earnings:number; reimbursements:number; arrears:number; statutory_deductions:number; other_deductions:number; recoveries:number; employer_contributions:number; component_results:Json; gross_pay:number; total_deductions:number; net_pay:number; status:string; on_hold:boolean; hold_reason:string|null; exceptions:Json; input_snapshot:Json; calculation_trace:Json; version:number; calculated_at:string };
type SalaryComponentRow = { id:string; company_id:string; root_id:string|null; version:number; name:string; code:string; display_name:string|null; description:string|null; component_type:string; calculation_method:string; fixed_amount:number|null; percentage:number|null; base_component_codes:string[]; minimum_amount:number|null; maximum_amount:number|null; priority:number; include_in_gross:boolean; include_in_net:boolean; include_in_ctc:boolean; taxable:boolean; statutory:boolean; prorate:boolean; allow_negative:boolean; allow_employee_override:boolean; show_on_salary_slip:boolean; show_zero_on_salary_slip:boolean; effective_from:string; effective_to:string|null; status:string; created_by:string|null; created_at:string; updated_at:string };
type SalaryTemplateRow = { id:string; company_id:string; root_id:string|null; version:number; name:string; code:string; description:string|null; salary_input_type:string; component_rules:Json; effective_from:string; effective_to:string|null; status:string; created_by:string|null; created_at:string; updated_at:string };
...
export type EmployeeDatabase = {
  public: {
    Tables: Omit<BaseDatabase["public"]["Tables"], "users" | "designations" | "companies"> & {
      ...
      salary_components: AttendanceTable<SalaryComponentRow, "company_id" | "name" | "code" | "component_type" | "calculation_method" | "effective_from">;
      salary_structure_templates: AttendanceTable<SalaryTemplateRow, "company_id" | "name" | "code" | "effective_from">;
